        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="nav-item">
                        <a href="mailto:llopez@atlanticcorredores.com" class="black">escríbenos</a>
                    </li>
                    <!--//dropdown-->
                    <li class="nav-item">
...
<section id="cotizar" class="content-block content-1-2 bg-image-cover" style="background-image:url({{ asset('atlantic/images/Background-con-mas-brillo.jpg') }});">
    <div class="container">
        <!-- Start Row -->
        <div class="row">
            <div class="margin-top90 col-sm-6">
                <h2></h2>
                <h1 class="white"><b class="sombra-texto-inicio">¡Completa el formulario<br>y cotiza al instante!<br></b></h1>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3 pad15 marginbot-iconos pad-bottom20">
                <img alt="Client Logo" src="{{ asset('atlantic/images/partner-logos/rimac.png') }}">
            </div>
            <div class="col-md-3 marginbot-iconos margin-bottom20">
                <img alt="Client Logo" src="{{ asset('atlantic/images/partner-logos/pacifico%20seguros.png') }}">
            </div>
            <div class="col-md-3 marginbot-iconos margin-bottom20" id="beneficios">
                <img alt="Client Logo" src="{{ asset('atlantic/images/partner-logos/la%20positiva.png') }}">
            </div>
            <div class="col-md-3 marginbot-iconos margin-bottom20">
                <img alt="Client Logo" src="{{ asset('atlantic/images/partner-logos/Mapfre_logo.svg.png') }}">
            </div>
            {{--<div class="col-md-3 margin-top15 marginbot-iconos">--}}
                {{--<img alt="Client Logo" src="{{ asset('atlantic/images/partner-logos/hdi_seguros_3.png') }}">--}}
            {{--</div>--}}
        </div>
        <!--end of row-->
    </div>
...
<section id="beneficios2" class="content-2-8 content-block-nopad bg-clouds">
    <div class="image-container col-sm-5 pull-left">
        <div class="background-image-holder" style="background-image:url({{ asset('atlantic/images/chicacarro.jpg') }});">
        </div>
    </div>
    <div class="container">
        <div class="row">
            ...
            <p class="lead"><b>Atlantic Corredores de Seguros</b> nace como una iniciativa para simplificar los procedimientos de cotización de un seguro de vehículos y tener de forma rápida un comparativo de precios y coberturas de las principales compañías de seguros.</p>
            <p class="lead">Además, buscamos mejorar nuestros procesos de atención de clientes y siniestros, de tal manera que el ahorro que generan estas mejoras pueda trasladarse al precio final en favor de nuestros clientes. <b>Atlantic Corredores de Seguros</b> es una plataforma especializada en cotización y promoción digital de seguros a nivel nacional</p>
                <!-- /.row -->
                <!-- /.row -->
            </div>
        </div>
...
<section id="totalnosotros" class="content-block content-1-3 bg-offwhite">
    <div class="container">
        ...
        <div class="row imagen-oculta">
            <img src="{{ asset('atlantic/images/cuadros3.png') }}" alt="" class="img-responsive center-block">
        </div>
        <div class="row imagen-muestra">
            <img src="{{ asset('atlantic/images/cuadros-lineal3.png') }}" alt="" class="img-responsive center-block">
        </div>
        <!-- /.row -->
    </div>
    <!-- /.container -->
...
<section id="content-2-1" class="content-block content-2-1 bg-deepocean">
    <div class="container text-center container-llamanos">
        ...
        <div class="row">
            <h2> <i class="fa fa-1x fa-inverse fa-phone"></i>&nbsp; +(511) 226 0736</h2>
        </div>
        <div class="row">
            <h2> <i class="fa fa-whatsapp fa-1x fa-inverse fa-fw"></i> 981-215-226</h2>
        </div>
    </div>
    <!-- /.container -->
</section>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <img class="img-responsive map-img" src="{{ asset('atlantic/images/foto-contacto.jpg') }}">
            </div>
        </div>
        <!-- /.row -->
    </div>
